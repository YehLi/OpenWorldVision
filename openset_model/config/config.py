...
_C.data_loader.train_label = ''                   # path to dataset, label_file
_C.data_loader.train_gan_label = ''                   # path to dataset, label_file
_C.data_loader.eval_label = ['']                    # path to dataset, label_file
_C.data_loader.soft_eval_label = ''                   # path to dataset, label_file
...
_C.data_loader.use_gan_data = False               # use data generated by gan
_C.data_loader.centroids = ''                     # load centroids
_C.data_loader.train_bbox_label = ''                   # path to dataset, label_file
_C.data_loader.test_bbox_label = ''
...
_C.model.selfsup_name = 'sup_moco'
_C.model.moco_dim = 128
_C.model.moco_K = 65536
_C.model.moco_m = 0.999
_C.model.moco_t = 0.2
_C.model.adv_epsilon = 1.0
_C.model.adv_alpha = 1.0
_C.model.adv_min_val = 0.0
_C.model.adv_max_val = 1.0
_C.model.adv_max_iters = 1
_C.model.adv_type = 'linf'
_C.model.centroids_grad = False

_C.bilinear = CN()
_C.bilinear.name = 'bilinear_onelayer'
_C.bilinear.nets = ['resnet_rs50', 'resnest50d']
_C.bilinear.net_dim = [2048, 2048]
_C.bilinear.embed_dim = 1024
_C.bilinear.net_resume = ['', '']
_C.bilinear.bilinear_resume = ''

_C.bert = CN()
_C.bert.layers = 2
_C.bert.dim = 768
_C.bert.intermediate_dim = 3072
_C.bert.head_num = 12
_C.bert.drop = 0.1
_C.bert.att_drop = 0.1
_C.bert.resume = '' 
_C.bert.patch_num = 1
...
_C.loss.rpl_gamma = 0.5                           # label smoothing (default: 0.1)
_C.loss.rpl_lambda_o = 0.1                        # label smoothing (default: 0.1)
_C.loss.rpl_lambda_unknown = 0.1                  # label smoothing (default: 0.1)
_C.loss.rpl = False
_C.loss.min_unknown_rpl = False
_C.loss.ce_centroids = False
_C.loss.ce_centroids_nograd = False
_C.loss.lambda_centr = 0.1
_C.loss.ce_supmoco = False
_C.loss.lambda_selfsup = 0.1
_C.loss.k_ukn = 0.0
_C.loss.ncerce_alpha = 0.0
_C.loss.ncerce_beta = 0.0
_C.loss.ncerce = False
_C.loss.gce_weight = 1.0
_C.loss.soft_label_weight = 1.0
_C.loss.gxent_k = 0.
_C.loss.gxent_q = 0.7
