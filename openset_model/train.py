...
from datasets import Dataset, DatasetTxt, DatasetTxtGAN, create_loader, resolve_data_config, Mixup, FastCollateMixup, AugMixDataset
...
def setup_loader(data_config):
    ...
    if cfg.data_loader.use_gan_data:
        ...
        dataset_train = DatasetTxt(cfg.data_loader.data_path, cfg.data_loader.train_label)
...
def main():
    ...
    #evaler = OpenWorldVisionEvaler(data_config)
