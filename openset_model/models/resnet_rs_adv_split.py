...
default_cfgs = {
    'resnet_rs50_adv_split': _cfg(
        url='',
        input_size=(3, 224, 224)),
    'resnet_rs101_adv_split': _cfg(
        url='',
        input_size=(3, 192, 192), pool_size=(6, 6), crop_pct=0.857, interpolation='bicubic'),
    'resnet_rs152_adv_split': _cfg(
        url='',
        input_size=(3, 224, 224)),
}
...
class ResNetRSAdvSplit(nn.Module):
    def __init__(self, block, layers, num_classes=1000, in_chans=3,
        ...
        self._type = _type
        super(ResNetRSAdvSplit, self).__init__()
    ...
    def forward(self, x, return_feats=False, target=None):
...
def _create_resnet_rs_adv_split(variant, pretrained=False, **kwargs):
    return build_model_with_cfg(
        ResNetRSAdvSplit, variant, default_cfg=default_cfgs[variant], pretrained=pretrained, **kwargs)

@register_model
def resnet_rs50_adv_split(pretrained=False, **kwargs):
    ...
    return _create_resnet_rs_adv_split('resnet_rs50_adv_split', pretrained, **model_args)

@register_model
def resnet_rs101_adv_split(pretrained=False, **kwargs):
    model_args = dict(block=Bottleneck, layers=[3, 4, 23, 3],
    stem_type='deep', stem_width=64, base_width=64, cardinality=1,
    block_args=dict(attn_layer='se'), **kwargs)
    return _create_resnet_rs_adv_split('resnet_rs101_adv_split', pretrained, **model_args)

@register_model
def resnet_rs101L_adv_split(pretrained=False, **kwargs):
    model_args = dict(block=Bottleneck, layers=[3, 4, 23, 3],
    stem_type='deep', stem_width=64, base_width=64, cardinality=1,
    block_args=dict(attn_layer='se'), **kwargs)
    return _create_resnet_rs_adv_split('resnet_rs101L_adv_split', pretrained, **model_args)